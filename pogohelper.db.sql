...
CREATE TABLE USERS(ID INT PRIMARY KEY NOT NULL, NAME TEXT NOT NULL, TEAM TEXT NOT NULL, LEVEL SMALLINT NOT NULL, FIRSTNAME TEXT, SURNAME TEXT, USERNAME TEXT, NOTIFICATIONS BOOLEAN DEFAULT 0);
